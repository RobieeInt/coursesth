...
<head>
    ...
    <title>INDO.STH Online Courses & Education</title>
    <meta name="robots" content="noindex, follow" />
    <meta name="description" content="Kelas Online, Jasa Pembuatan Aplikasi, Jasa Pembuatan Skema Jaringan">
    ...
    <!-- CSS ============================================ -->
    <link rel="stylesheet" href="{{ asset('course/assets/css/vendor/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('course/assets/css/vendor/slick.css') }}">
    <link rel="stylesheet" href="{{ asset('course/assets/css/vendor/slick-theme.css') }}">
    <link rel="stylesheet" href="{{ asset('course/assets/css/plugins/sal.css') }}">
    <link rel="stylesheet" href="{{ asset('course/assets/css/plugins/feather.css') }}">
    <link rel="stylesheet" href="{{ asset('course/assets/css/plugins/fontawesome.min.css') }}">
    <link rel="stylesheet" href="{{ asset('course/assets/css/plugins/euclid-circulara.css') }}">
    <link rel="stylesheet" href="{{ asset('course/assets/css/plugins/swiper.css') }}">
    <link rel="stylesheet" href="{{ asset('course/assets/css/plugins/magnify.css') }}">
    <link rel="stylesheet" href="{{ asset('course/assets/css/plugins/odometer.css') }}">
    <link rel="stylesheet" href="{{ asset('course/assets/css/plugins/animation.css') }}">
    <link rel="stylesheet" href="{{ asset('course/assets/css/plugins/bootstrap-select.min.css') }}">
    <link rel="stylesheet" href="{{ asset('course/assets/css/plugins/jquery-ui.css') }}">
    <link rel="stylesheet" href="{{ asset('course/assets/css/plugins/magnigy-popup.min.css') }}">
    <link rel="stylesheet" href="{{ asset('course/assets/css/style.css') }}">
    @livewireStyles()
</head>
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-12">
                                    <div class="inner">
                                        ...
                                        <h4 class="title mb--10">Free Online Courses from Histudy School To Education
                                        </h4>
                                        <p class="mb--15">Top instructors from around the world</p>
                                    ...
                                    <div class="single-slide">
                                        <div class="rbt-card event-grid-card variation-01 rbt-hover">
                                            ...
                                            <div class="rbt-card-body">
                                                ...
                                                <h4 class="rbt-card-title"><a href="event-details.html">Elegant
                                                        Light Box Paper Cut Dioramas in UK</a></h4>
                                    ...
                                    <div class="single-slide">
                                        <div class="rbt-card event-grid-card variation-01 rbt-hover">
                                            ...
                                            <div class="rbt-card-body">
                                                ...
                                                <h4 class="rbt-card-title"><a href="event-details.html">Most
                                                        Effective Ways for Education's Problem</a></h4>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="rbt-team-tab-content tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade" id="team-tab3" role="tabpanel"
                            ...
                            <div class="tab-pane fade" id="team-tab4" role="tabpanel"
                            ...
                            <div class="tab-pane fade" id="team-tab5" role="tabpanel"
                            ...
                            <div class="tab-pane fade" id="team-tab6" role="tabpanel"
                    ...
                    <div class="col-lg-5">
                        ...
                        <ul class="rbt-team-tab-thumb nav nav-tabs" id="myTab" role="tablist">
                            <li>
                                <a class="active" id="team-tab1-tab" data-bs-toggle="tab"
                                    data-bs-target="#team-tab1" role="tab" aria-controls="team-tab1"
                                    aria-selected="true">
                                    <div class="rbt-team-thumbnail">
                                        <div class="thumb">
                                            <img src="assets/images/team/team-01.jpg" alt="Testimonial Images">
                            ...
                            <li>
                                <a id="team-tab2-tab" data-bs-toggle="tab" data-bs-target="#team-tab2"
                                    role="tab" aria-controls="team-tab2" aria-selected="false">
                                    <div class="rbt-team-thumbnail">
                                        <div class="thumb">
                                            <img src="assets/images/team/team-02.jpg" alt="Testimonial Images">
                                        </div>
                            ...
                            <li>
                                <a id="team-tab3-tab" data-bs-toggle="tab" data-bs-target="#team-tab3"
                                    role="tab" aria-controls="team-tab3" aria-selected="false">
                                    <div class="rbt-team-thumbnail">
                                        <div class="thumb">
                                            <img src="assets/images/team/team-03.jpg" alt="Testimonial Images">
                                        </div>
                            ...
                            <li>
                                <a id="team-tab4-tab" data-bs-toggle="tab" data-bs-target="#team-tab4"
                                    role="tab" aria-controls="team-tab4" aria-selected="false">
                                    <div class="rbt-team-thumbnail">
                                        <div class="thumb">
                                            <img src="assets/images/team/team-04.jpg" alt="Testimonial Images">
                                        </div>
                            ...
                            <li>
                                <a id="team-tab5-tab" data-bs-toggle="tab" data-bs-target="#team-tab5"
                                    role="tab" aria-controls="team-tab5" aria-selected="false">
                                    <div class="rbt-team-thumbnail">
                                        <div class="thumb">
                                            <img src="assets/images/team/team-05.jpg" alt="Testimonial Images">
                                        </div>
                            ...
                            <li>
                                <a id="team-tab6-tab" data-bs-toggle="tab" data-bs-target="#team-tab6"
                                    role="tab" aria-controls="team-tab6" aria-selected="false">
                                    <div class="rbt-team-thumbnail">
                                        <div class="thumb">
                                            <img src="assets/images/team/team-06.jpg" alt="Testimonial Images">
                                        </div>
                ...
                <div class="row align-items-center">
                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-12">
                        <p class="rbt-link-hover text-center text-lg-start">Copyright © 2023 <a
                                href="https://themeforest.net/user/rbt-themes">INDO.STH</a> All Rights Reserved
                        </p>
                    </div>
                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-12">
                        <ul
...
============================================ -->
    <!-- Modernizer JS -->
    <script src="{{ asset('course/assets/js/vendor/modernizr.min.js') }}"></script>
    <!-- jQuery JS -->
    <script src="{{ asset('course/assets/js/vendor/jquery.js') }}"></script>
    <!-- Bootstrap JS -->
    <script src="{{ asset('course/assets/js/vendor/bootstrap.min.js') }}"></script>
    <!-- sal.js -->
    <script src="{{ asset('course/assets/js/vendor/sal.js') }}"></script>
    <script src="{{ asset('course/assets/js/vendor/swiper.js') }}"></script>
    <script src="{{ asset('course/assets/js/vendor/magnify.min.js') }}"></script>
    <script src="{{ asset('course/assets/js/vendor/jquery-appear.js') }}"></script>
    <script src="{{ asset('course/assets/js/vendor/odometer.js') }}"></script>
    <script src="{{ asset('course/assets/js/vendor/backtotop.js') }}"></script>
    <script src="{{ asset('course/assets/js/vendor/isotop.js') }}"></script>
    <script src="{{ asset('course/assets/js/vendor/imageloaded.js') }}"></script>

    <script src="{{ asset('course/assets/js/vendor/wow.js') }}"></script>
    <script src="{{ asset('course/assets/js/vendor/waypoint.min.js') }}"></script>
    <script src="{{ asset('course/assets/js/vendor/easypie.js') }}"></script>
    <script src="{{ asset('course/assets/js/vendor/text-type.js') }}"></script>
    <script src="{{ asset('course/assets/js/vendor/jquery-one-page-nav.js') }}"></script>
    <script src="{{ asset('course/assets/js/vendor/bootstrap-select.min.js') }}"></script>
    <script src="{{ asset('course/assets/js/vendor/jquery-ui.js') }}"></script>
    <script src="{{ asset('course/assets/js/vendor/magnify-popup.min.js') }}"></script>
    <script src="{{ asset('course/assets/js/vendor/paralax-scroll.js') }}"></script>
    <script src="{{ asset('course/assets/js/vendor/paralax.min.js') }}"></script>
    <script src="{{ asset('course/assets/js/vendor/countdown.js') }}"></script>
    <!-- Main JS -->
    <script src="{{ asset('course/assets/js/main.js') }}"></script>
