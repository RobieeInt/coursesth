                    ...
                    <div class="thumbnail-wrapper">
                        <div class="thumbnail image-1">
                            <img data-parallax='{"x": 0, "y": -20}'
                                src="{{ asset('course/assets/images/banner/content.jpg') }}" alt="Education Images">
                        </div>
                        <div class="thumbnail image-2 d-none d-xl-block">
                            <img data-parallax='{"x": 0, "y": 60}'
                                src="{{ asset('course/assets/images/banner/content2.jpg') }}" alt="Education Images">
                        </div>
                        <div class="thumbnail image-3 d-none d-md-block">
                            <img data-parallax='{"x": 0, "y": 80}'
                                src="{{ asset('course/assets/images/banner/content3.jpg') }}" alt="Education Images">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="inner pl--50 pl_sm--0 pl_md--0">
                        <div class="section-title text-start">
                            ...
                            <h2 class="title">Know About INDO.STH <br /> Learning Platform</h2>
                        </div>
                        ...
                        <div class="rbt-feature-wrapper mt--20 ml_dec_20">
                            <div class="rbt-feature feature-style-2 rbt-radius">
                                ...
                                <div class="feature-content">
                                    ...
                                    <p class="feature-description">It is a long established fact that a reader
                                        will
                            ...
                            <div class="rbt-feature feature-style-2 rbt-radius">
                                ...
                                <div class="feature-content">
                                    ...
                                    <p class="feature-description">Sed distinctio repudiandae eos recusandae
                                        laborum eaque non eius iure suscipit laborum eaque non eius iure suscipit.
                                    </p>
                                </div>
                            </div>
                        </div>
