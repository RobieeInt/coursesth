                                        ...
                                        <div class="inner">
                                            <div class="content">
                                                ...
                                                <span class="news-text"><img
                                                        src="{{ asset('course/assets/images/icons/hand-emojji.svg') }}"
                                        ...
                                        <li class="has-child-menu">
                                            <a href="#">
                                                <img class="left-image"
                                                    src="{{ asset('course/assets/images/icons/en-us.png') }}"
                                                    alt="Language Images">
                                            ...
                                            <ul class="sub-menu">
                                                <li>
                                                    <a href="#">
                                                        <img class="left-image"
                                                            src="{{ asset('course/assets/images/icons/fr.png') }}"
                                                            alt="Language Images">
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img class="left-image"
                                                            src="{{ asset('course/assets/images/icons/de.png') }}"
                                                            alt="Language Images">
                ...
                <div class="mainbar-row rbt-navigation-center align-items-center">
                    <div class="header-left rbt-header-content">
                        <div class="header-info">
                            <div class="logo">
                                <a href="index.html">
                                    <img src="{{ asset('course/assets/images/logo/logo.png') }}"
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="01-main-demo.html"><img
                                                                        src="{{ asset('course/assets/images/splash/demo/h1.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="12-marketplace.html"><img
                                                                        src="{{ asset('course/assets/images/splash/demo/h12.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h4 class="title"><a
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="04-kindergarten.html"><img
                                                                        src="{{ asset('course/assets/images/splash/demo/h4.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h4 class="title"><a
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="13-university-classic.html"><img
                                                                        src="{{ asset('course/assets/images/splash/demo/h13.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h4 class="title"><a
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="14-home-elegant.html"><img
                                                                        src="{{ asset('course/assets/images/splash/demo/h14.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="09-gym-coaching.html"><img
                                                                        src="{{ asset('course/assets/images/splash/demo/h9.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="03-online-school.html"><img
                                                                        src="{{ asset('course/assets/images/splash/demo/h3.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h4 class="title"><a
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="06-university-status.html"><img
                                                                        src="{{ asset('course/assets/images/splash/demo/h6.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h4 class="title"><a
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="15-home-technology.html"><img
                                                                        src="{{ asset('course/assets/images/splash/demo/h15.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h4 class="title"><a
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="07-instructor-portfolio.html"><img
                                                                        src="{{ asset('course/assets/images/splash/demo/h7.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h4 class="title"><a
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="08-language-academy.html"><img
                                                                        src="{{ asset('course/assets/images/splash/demo/h8.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h4 class="title"><a
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="11-single-course.html"><img
                                                                        src="{{ asset('course/assets/images/splash/demo/h11.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h4 class="title"><a
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="10-online-course.html"><img
                                                                        src="{{ asset('course/assets/images/splash/demo/h10.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h4 class="title"><a
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="05-classic-lms.html"><img
                                                                        src="{{ asset('course/assets/images/splash/demo/h5.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h4 class="title"><a
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="02-course-school.html"><img
                                                                        src="{{ asset('course/assets/images/splash/demo/h2.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h4 class="title"><a
                                                ...
                                                <div
                                                    ...
                                                    <div class="demo-single">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="#"><img
                                                                        src="{{ asset('course/assets/images/splash/demo/coming-soon-1.png') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                ...
                                                <div
                                                    ...
                                                    <div class="demo-single">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="#"><img
                                                                        src="{{ asset('course/assets/images/splash/demo/coming-soon-2.png') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                ...
                                                <div
                                                    ...
                                                    <div class="demo-single">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="#"><img
                                                                        src="{{ asset('course/assets/images/splash/demo/coming-soon-3.png') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                ...
                                                <div class="col-lg-12 col-xl-3 col-xxl-3 single-mega-item">
                                                    <div class="mega-category-item">
                                                        ...
                                                        <div class="nav-category-item">
                                                            <div class="thumbnail">
                                                                <div class="image"><img
                                                                        src="{{ asset('course/assets/images/course/category-2.png') }}"
                                                        ...
                                                        <div class="nav-category-item">
                                                            <div class="thumbnail">
                                                                <div class="image"><img
                                                                        src="{{ asset('course/assets/images/course/category-1.png') }}"
                                                                        alt="Course images"></div>
                                                                <a href="course-filter-one-toggle.html">
                                                        ...
                                                        <div class="nav-category-item">
                                                            <div class="thumbnail">
                                                                <div class="image"><img
                                                                        src="{{ asset('course/assets/images/course/category-4.png') }}"
                                                                        alt="Course images"></div>
                                                                <a href="course-filter-one-toggle.html">
                                                        ...
                                                        <div class="nav-category-item">
                                                            <div class="thumbnail">
                                                                <div class="image"><img
                                                                        src="{{ asset('course/assets/images/course/category-9.png') }}"
                                                                        alt="Course images"></div>
                                                                <a href="course-filter-one-toggle.html">
                                                                    <span>Academy</span>
                                                                    <i class="feather-chevron-right"></i>
                                                ...
                                                <div class="col-lg-12 col-xl-4 col-xxl-4 single-mega-item">
                                                    <div class="rbt-ads-wrapper">
                                                        <a class="d-block" href="#"><img
                                                                src="{{ asset('course/assets/images/service/mobile-cat.jpg') }}"
                                    ...
                                    <div class="inner">
                                        <div class="rbt-admin-profile">
                                            <div class="admin-thumbnail">
                                                <img src="{{ asset('course/assets/images/team/avatar.jpg') }}"
                                                    alt="User Images">
                                            </div>
        ...
        <div class="inner-wrapper">
            <div class="inner-top">
                <div class="content">
                    <div class="logo">
                        <a href="index.html">
                            <img src="{{ asset('course/assets/images/logo/logo.png') }}" alt="Education Logo Images">
                        </a>
                    </div>
                    <div class="rbt-btn-close">
            ...
            <nav class="side-nav w-100">
                <ul class="rbt-minicart-wrapper">
                    <li class="minicart-item">
                        <div class="thumbnail">
                            <a href="#">
                                <img src="{{ asset('course/assets/images/product/1.jpg') }}" alt="Product Images">
                            </a>
                        </div>
                    ...
                    <li class="minicart-item">
                        <div class="thumbnail">
                            <a href="#">
                                <img src="{{ asset('course/assets/images/product/7.jpg') }}" alt="Product Images">
                            </a>
                        </div>
                        <div class="product-content">
                    ...
                    <li class="minicart-item">
                        <div class="thumbnail">
                            <a href="#">
                                <img src="{{ asset('course/assets/images/product/3.jpg') }}" alt="Product Images">
                            </a>
                        </div>
                        <div class="product-content">
                    ...
                    <li class="minicart-item">
                        <div class="thumbnail">
                            <a href="#">
                                <img src="{{ asset('course/assets/images/product/4.jpg') }}" alt="Product Images">
                            </a>
                        </div>
                        <div class="product-content">
